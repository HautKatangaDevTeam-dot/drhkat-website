...
const faqs = [
  ...
  },
  {
    ...
    a: "Vous pouvez écrire à div.info@edrhkat.com ou utiliser le lien vers la carte pour le siège.",
  },
  {
    q: "Quels sont les principaux services de la DRHKAT ?",
    a: "Mobilisation des taxes, droits et redevances, conformité, recouvrement, lutte contre la fraude et assistance au public.",
  },
  {
    q: "La déclaration et le paiement en ligne sont-ils disponibles ?",
    a: "Le portail public numérique est en déploiement progressif. Consultez la section Services en ligne pour les informations et liens utiles.",
  },
  {
          ...
          >
              <div className="flex items-start gap-4">
                ...
                <p className="mt-2 text-sm leading-relaxed text-slate-600">
                  Utilisez les canaux ci-dessous.
                </p>
